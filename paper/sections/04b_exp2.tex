...
\textbf{RouteLLM-SW is not applicable} to this setting: it is architecturally binary (strong/weak) and extending it to $K > 2$ arms would require $O(K^2)$ separate classifiers, a structural limitation shared by all static supervised routers.
