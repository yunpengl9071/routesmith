...
RouteSmith achieved significant cost reduction:

| Metric | Static Premium | RouteSmith | Reduction |
|--------|----------------|------------|-----------|
| Cost/Query | $0.83 | $0.26 | 68.7% |

### 4.2 Quality Retention

RouteSmith maintains quality comparable to always-premium routing.

### 4.3 Learning Dynamics

Thompson Sampling learns optimal routing within ~40 queries.

### 4.4 Routing Distribution

By category: Technical queries route 90% to economy, while FAQ routes 95% to premium.

### 4.5 Cost-Quality Tradeoff

RouteSmith balances cost and quality through its reward function.

### 4.6 LLM-as-Judge Evaluation

We validated quality using LLM-as-judge (n=10 queries, r=0.906 correlation).

### 4.7 Real-World Validation

100-query experiment achieved 100% success rate with 68.7% cost reduction.

## 5. Discussion

RouteSmith demonstrates that Thompson Sampling effectively optimizes LLM routing.

## 6. Conclusion

RouteSmith achieves 68.7% cost reduction while maintaining quality through adaptive routing.
